...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // Ahora sacamos el listado de sólo los CDs
    System.out.println("Listado con sólo los CDs");
    coleccion.acepta(new VisitadorColeccion() {
      
      @Override
      public void visita(DVDVideo dvd) {
        // No hacemos nada porque solo hay que listar los CDS
      }
    ...
    // Imprime la duracion total
    VisitadorColeccionDuracionTotal visitadorDuracion = new VisitadorColeccionDuracionTotal();
    coleccion.acepta(visitadorDuracion);
    System.out.printf("La duración total de la coleccion es de %d minutos%n", visitadorDuracion.getTotal());
  }
